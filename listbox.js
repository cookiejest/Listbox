define(["jquery", "./bootstrap.min", "text!./style.css", "qlik"], function ($, bootstrap, cssContent, qlik)  {
	'use strict';
	...
	return {
		...
		paint : function ($element, layout) {
			...
			var self = this,
			html = '<div class="' + styletype + '" style="width:' + (overallwidth) + '% !important;overflow:auto !important;height:' + (height) + 'px;">',
			style;
